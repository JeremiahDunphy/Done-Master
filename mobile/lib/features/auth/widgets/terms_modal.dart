            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: const [
                  ...
                  Text('The Platform operates as a neutral gig marketplace designed exclusively to facilitate the connection between Posters seeking specific, temporary services ("Jobs") and Doers offering professional services ("Gigs").'),

                  _SectionTitle('2.2 Platform as Facilitator'),
                  Text('Done is not an employer, agent, or representative of either Posters or Doers. Done\'s role is strictly limited to providing the technology infrastructure for posting, application, communication, and payment processing. Done does not supervise, direct, or control the work performed by Doers, nor does it guarantee the quality, suitability, or legality of the Jobs or Gigs offered. Users expressly acknowledge and agree that Done is not a party to any agreement or contract entered into between the Poster and the Doer.'),

                  _SectionHeader('ARTICLE III. FINANCIAL TERMS AND FEES'),
                  _SectionTitle('3.1 Platform Transaction Fee'),
                  Text('Done shall charge a service fee ("Transaction Fee") equal to ten percent (10%) of the total agreed-upon monetary value for all completed transactions facilitated through the Platform. This fee is non-negotiable and is automatically calculated and deducted from the payment remitted to the Doer.'),
                  ...
                  Text('Posters must pre-fund the full agreed-upon amount for a Job into an escrow or holding account before the Doer commences work. Funds will be held until the Poster provides explicit approval of job completion. Doers will be paid upon Poster approval, less the 10% Transaction Fee.'),

                  _SectionTitle('3.4 Non-Refundable Fees'),
                  Text('All Platform fees (the 10% Transaction Fee) are non-refundable, except in cases where Done determines, at its sole discretion, that the Doer failed to render any portion of the service whatsoever.'),
